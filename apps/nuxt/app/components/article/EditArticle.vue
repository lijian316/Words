...
import { getNetworkTranslate, getSentenceAllText, getSentenceAllTranslateText } from '@typewords/core/hooks/translate.ts'
import { genArticleSectionData, splitCNArticle2, splitEnArticle2, usePlaySentenceAudio } from '@typewords/core/hooks/article.ts'
import { _nextTick, _parseLRC, cloneDeep, last } from '@typewords/core/utils'
...
import { LOCAL_FILE_KEY } from '@typewords/core/config/env.ts'
import { TranslateEngine } from '@typewords/core/types/enum.ts'
